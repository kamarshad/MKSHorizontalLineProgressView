...
- (void)doIntialSetup{
    ...
    self.horizontalLineProgressView1.lineCap = MKSLineProgressViewCapSquare;
    
    //Second Horizontal line with percentage text
    self.horizontalLineProgressView2.progressValue = 18.0f;
    ...
    self.horizontalLineProgressView1.lineCap = MKSLineProgressViewCapButt;
    
    //Horizontal line without percentage text
    self.horizontalLineProgressView3.progressValue = 88.0f;
